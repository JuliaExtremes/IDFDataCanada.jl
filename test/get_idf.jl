@testset "get_idf" begin
    true_df = CSV.read("test/data/8300301.csv", DataFrame, type=String)

    stationid, lat, lon, altitude, data_df, stationname = get_idf("test/data/idf_v-3.20_2021_03_26_830_PE_8300301_CHARLOTTETOWN_A.txt");
